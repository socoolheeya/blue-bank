...
val loanApplicationScenarios by testSuite("Loan application scenarios") {
    testFixture { LoanApplicationScenarioContext() } asContextForEach {
        Scenario("valid account and exact score income and DSR boundaries submit an application") {
        ...
        Scenario("invalid account and income and DSR above boundaries are rejected") {
        ...
        Scenario("minimum credit score is inclusive") {
        ...
        Scenario("one point below the minimum credit score is rejected") {
        ...
        Scenario("submit get list and missing application cover public queries") {
        ...
        listOf(
            ...
            Scenario("approval maps $product to the $expected family and preserves money and rate") {
        ...
        Scenario("reject preserves reason and approval missing fails") {
