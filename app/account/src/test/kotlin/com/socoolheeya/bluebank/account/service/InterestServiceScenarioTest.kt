...
val interestServiceScenarios by testSuite("Interest calculations") {
    Scenario("monthly calculation returns the data service payment", ::InterestScenarioContext) {
    ...
    Scenario("average calculation preserves its period", ::InterestScenarioContext) {
    ...
    Scenario("total and complete history are returned", ::InterestScenarioContext) {
    ...
    Scenario("period history forwards dates and filters results", ::InterestScenarioContext) {
    ...
    Scenario("expected interest preserves explicit and default month arguments", ::InterestScenarioContext) {
