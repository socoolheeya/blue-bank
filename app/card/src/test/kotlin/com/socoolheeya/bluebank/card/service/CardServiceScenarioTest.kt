...
val cardServiceScenarios by testSuite("Card service scenarios") {
    Scenario("lookup and customer lists map stored cards", ::CardScenarioContext) {
    ...
    Scenario("owner can activate toggle lose and terminate a card", ::CardScenarioContext) {
    ...
    Scenario("mutations reject a different owner", ::CardScenarioContext) {
    ...
    Scenario("every lifecycle mutation rejects a missing card", ::CardScenarioContext) {
