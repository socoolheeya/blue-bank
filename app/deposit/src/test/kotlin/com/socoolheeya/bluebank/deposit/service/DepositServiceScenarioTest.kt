...
val depositServiceScenarios by testSuite("Deposit service scenarios") {
    testFixture { DepositScenarioContext() } asContextForEach {
        Scenario("creation validates account ownership and maps product period and money") {
        ...
        Scenario("creation rejects invalid accounts and accounts owned by another customer") {
        ...
        Scenario("generated deposit numbers preserve prefix and uniqueness") {
            Given("an account owned by the deposit customer") {
                accounts.addAccount(9, 7)
            }
        ...
        Scenario("owner can activate contribute withdraw and terminate with state changes") {
        ...
        Scenario("all mutations reject a different owner without changing state") {
            Given("an account owned by the deposit customer") {
                accounts.addAccount(9, 7)
            }
        ...
        Scenario("lookup and customer listing return only matching deposits and missing lookup fails") {
        ...
        Scenario("invalid state transitions and monetary boundaries preserve state balance and commands") {
